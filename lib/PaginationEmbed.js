...
class PaginationEmbed {
    ...
    async initialize() {
        ...
        this.handler = new ReactionHandler.continuousReactionStream(this.message, (user) => user.id === this.invoker.author.id, false, { maxMatches: this.maxMatches, time: this.timeout });
